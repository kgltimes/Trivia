...
class TriviaCard extends React.Component { // eslint-disable-line react/prefer-stateless-function
  render() {
    ...
    return (<div className="page fullscreen">
      ...
      <a className="resp-sharing-button__link" href={`https://facebook.com/sharer/sharer.php?u=https%3A%2F%2Fkgltimes.com%2Ftrivia%2F%23%2Ftrivia%3Fq%3D${encodeURIComponent(`${trivia.question && trivia.question.content}\nTrue or False `)}`} target="_blank" aria-label="Facebook">
